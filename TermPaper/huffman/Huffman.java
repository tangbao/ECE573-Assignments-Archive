...
public class Huffman {
    ...
    public static void main(String[] args) {
        if      (args[0].equals("-")) {
          ...
          compress();
          double running_time = sw.elapsedTime();
          StdOut.println("The time of compress is "+running_time+" s");
        }
        else if (args[0].equals("+")) {
          Stopwatch sw = new Stopwatch();
          expand();
          double running_time = sw.elapsedTime();
          StdOut.println("The time of depress is "+running_time+" s");
        }
        else throw new IllegalArgumentException("Illegal command line argument");
        System.out.println("test1321");
